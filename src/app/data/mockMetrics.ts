...
export const mockCardsData: MetricCardData[] = [
    {
        ...
        metrics: [
            ...
            { label: "LFL (к пред. месяцу)", value: 90, variant: "error" },
        ],
        total: 200,
    },
    {
        ...
        metrics: [
            ...
            { label: "LFL (к пред. месяцу)", value: 70, variant: "error" },
        ],
        total: 150,
    },
    {
        ...
        metrics: [
            ...
            { label: "LFL (к пред. месяцу)", value: 85, variant: "error" },
        ],
        total: 180,
    },
];
...
export const mockLFL: Record<
    string, // название карточки
    Record<string, { percent: number; count: number; variant?: "default" | "error" }>
> = {
    "Карточка 1": {
        "терапевт_all_all": { percent: 25, count: 12, variant: "default" },
