...
const appointmentsDetails: Record<string, AppointmentDetail[]> = {
    a1: [
        ...
        { id: "s13", name: "Определение уровня тропонина Т/И", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 480 ₽", done: true, clinical: true },
        { id: "s13", name: "Эхокардиография", mandatoryOukr: true, assigned: true, reason: "-", cost: "4 950 ₽", done: true, clinical: true },
        { id: "s14", name: "Рентгенография грудной клетки", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 750 ₽", done: true, clinical: true },
        { id: "s15", name: "Биохимический анализ крови", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 632 ₽", done: true, clinical: true },
        { id: "s16", name: "Анализ мочи", mandatoryOukr: false, assigned: true, reason: "-", cost: "650 ₽", done: true, clinical: true },
        { id: "s17", name: "КТ грудной клетки", assigned: true, reason: "-", cost: "4 950 ₽", done: true, clinical: false },
    ],
    a2: [
        { id: "s10", name: "ЭКГ в 12 отведениях", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 760 ₽", done: false, clinical: true },
        { id: "s11", name: "Электрокардиографический мониторинг", mandatoryOukr: true, assigned: false, reason: "-", cost: "3 650 ₽", done: false, clinical: true },
        { id: "s13", name: "Определение уровня тропонина Т/И", mandatoryOukr: true, assigned: false, reason: "-", cost: "1 450 ₽", done: false, clinical: true },
        { id: "s13", name: "Эхокардиография", mandatoryOukr: true, assigned: false, reason: "-", cost: "6 000 ₽", done: false, clinical: true },
        { id: "s14", name: "Рентгенография грудной клетки", mandatoryOukr: true, assigned: false, reason: "-", cost: "3 800 ₽", done: false, clinical: true },
        { id: "s16", name: "Анализ мочи", mandatoryOukr: false, assigned: true, reason: "-", cost: "600 ₽", done: false, clinical: true },
    ],
    a3: [
        { id: "s10", name: "ЭКГ в 12 отведениях", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 804 ₽", done: true, clinical: true },
        { id: "s11", name: "Электрокардиографический мониторинг", mandatoryOukr: true, assigned: true, reason: "-", cost: "3 500 ₽", done: true, clinical: true },
        { id: "s13", name: "Определение уровня тропонина Т/И", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 600 ₽", done: true, clinical: true },
        { id: "s13", name: "Эхокардиография", mandatoryOukr: true, assigned: false, reason: "-", cost: "4 800 ₽", done: false, clinical: true },
        { id: "s15", name: "Биохимический анализ крови", mandatoryOukr: false, assigned: true, reason: "-", cost: "1 408 ₽", done: false, clinical: true },
        { id: "s16", name: "Анализ мочи", mandatoryOukr: false, assigned: true, reason: "-", cost: "600 ₽", done: false, clinical: true },
        { id: "s17", name: "КТ грудной клетки", assigned: true, reason: "-", cost: "7 000 ₽", done: false, clinical: false },
    ],
    a4: [
        { id: "s10", name: "ЭКГ в 12 отведениях", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 760 ₽", done: true, clinical: true },
        { id: "s11", name: "Электрокардиографический мониторинг", mandatoryOukr: true, assigned: true, reason: "-", cost: "3 300 ₽", done: true, clinical: true },
        { id: "s13", name: "Определение уровня тропонина Т/И", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 500 ₽", done: true, clinical: true },
        { id: "s13", name: "Эхокардиография", mandatoryOukr: true, assigned: true, reason: "-", cost: "4 500 ₽", done: true, clinical: true },
        { id: "s14", name: "Рентгенография грудной клетки", mandatoryOukr: true, assigned: true, reason: "-", cost: "1 600 ₽", done: true, clinical: true },
        { id: "s15", name: "Биохимический анализ крови", mandatoryOukr: true, assigned: false, reason: "-", cost: "1 200 ₽", done: false, clinical: true },
        { id: "s16", name: "Стресс-эхокардиография", mandatoryOukr: true, assigned: true, reason: "-", cost: "4 200 ₽", done: false, clinical: true },
        { id: "s17", name: "Анализ мочи", mandatoryOukr: false, assigned: false, reason: "-", cost: "504 ₽", done: false, clinical: true },
        { id: "s18", name: "Коронарография", mandatoryOukr: false, assigned: true, reason: "-", cost: "4 600 ₽", done: true, clinical: true },
        { id: "s19", name: "КТ грудной клетки", assigned: true, reason: "-", cost: "1 600 ₽", done: true, clinical: false },
    ],
    a5: [
